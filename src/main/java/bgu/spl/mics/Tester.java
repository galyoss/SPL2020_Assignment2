...
public class Tester {
    ...
    */
    ...
    public void runTestsFromFile() {
        ...
        int failedTests = 0;
        Test currentTests[];
        Diary diaryInstance = Diary.getDiary();
        try {
            currentTests = getTestsFromJson("Tests.json");
            for (int i = 0; i < currentTests.length; i++) {
                MessageBusImpl.getMessageBus().resetMessagebus();
    ...
    */
    ...
    public void runLogicalTests() {
        try {
            ...
            MessageBusImpl messageInstance = MessageBusImpl.getMessageBus();
           ...
           /* hanSoloSender2.start();
            ...
            do {
                ...
                if (m != null){
                    ...
                    if (numMesssagesReceived>1497)
                        System.out.println(numMesssagesReceived);
                }
